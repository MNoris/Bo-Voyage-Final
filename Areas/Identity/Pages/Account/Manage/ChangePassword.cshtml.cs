...
namespace Bo_Voyage_Final.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("NewPassword", ErrorMessage = "Le nouveau mot de passe et le mot de passe de confirmation ne correspodnent pas.")]
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Impossible d'identifier l'utilisateur avec l'ID '{_userManager.GetUserId(User)}'.");
            }
